...
PLACE = {
    # ---- left band: buck-module header, breakout, protection ----
    "J14": (8.0, 30.0, 90),
    "J2": (40.0, 48.0, 0),
    ...
    "D14": (104.0, 104.0, 0),
    # ---- bottom terminal row ----
    "F1": (18.0, 11.0, 0), "J16": (34.0, 113.0, 0),
    "J22": (50.0, 113.0, 0), "J9": (108.0, 113.0, 0),
...
MOUNTING = [
    ...
    ("MountingHole_3.2mm_M3", 16.0, 45.0), ("MountingHole_3.2mm_M3", 16.0, 66.0),  # strap the buck module here
